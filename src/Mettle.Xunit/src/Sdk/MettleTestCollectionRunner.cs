...
namespace Mettle.Xunit.Sdk
{
    ...
    public class MettleTestCollectionRunner : TestCollectionRunner<IXunitTestCase>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MettleTestCollectionRunner"/> class.
        /// </summary>
        ...
        /// </summary>
        protected virtual Dictionary<Type, object> CollectionFixtureMappings { get; private set; } = new Dictionary<Type, object>();
        ...
        {
            await this.CreateCollectionFixturesAsync().ConfigureAwait(false);
        ...
        {
            Check.NotNull(nameof(fixtureType), fixtureType);
